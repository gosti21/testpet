    ...
    <form action="{{ route('admin.covers.update', $cover) }}" method="POST" enctype="multipart/form-data">
        ...
        <figure class="relative mb-4">
            ...
            <div class="absolute top-8 right-8">
                <label class="flex items-center px-4 py-2 rounded-lg bg-white cursor-pointer text-gray-700">
                    ...
                    actualizar imagen
                    <input type="file" class="hidden" accept="image/*" wire:model="image/*" name="image"
        ...
        <div class="mb-4">
            ...
            <x-input name="title" value="{{ old('title', $cover->title) }}" class="w-full"
                placeholder="Por favor ingrese el titulo de la protada" />
        </div>
        ...
        <div class="mb-4">
            ...
            <x-input type="date" name="start_at" value="{{ old('start_at', $cover->start_at->format('Y-m-d')) }}"
                class="w-full" placeholder="Por favor ingrese el titulo de la protada" />
        </div>
