                                ...
                                @foreach ($option->pivot->features as $feature)
                                    <li>
                                        ...
                                        @switch($option->type)
                                            @case(1)
                                                <button
                                                    class="w-20 h-8 font-semibold uppercase text-sm rounded-lg {{ $selectedFeatures[$option->id] == $feature['id'] ? 'bg.red-500 text-white' : 'border border-gray-200 text-gray-700' }} "
